...
const LandingPage = () => {
  return (
    <div className="bg-gray-900 text-white">
      {/* Home */}
      <section className="container mx-auto flex flex-col py-6 h-screen ">
      ...
      <section className="bg-gray-800 py-16 h-screen">
...
const CardProp: React.FC<Card> = ({ title, description }) => {
  return (
